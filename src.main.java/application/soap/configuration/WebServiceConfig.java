package application.soap.configuration;
...
import application.soap.endpoint.ProductsEndpoint;
...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema productSchema) {
		...
		wsdl11Definition.setTargetNamespace(ProductsEndpoint.NAMESPACE_URI);
